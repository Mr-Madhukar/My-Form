...
const items = [
  ...
  },
  {
    ...
    answer:
      "My Form is free during the beta. Pricing will be announced before any paid plans launch.",
  },
  {
    ...
    >
      ...
      <div className="relative rounded-[0.95rem] bg-[#111] px-5 py-4 shadow-[inset_0_1px_1px_rgba(255,255,255,0.06)] border border-white/2">
        <button
          ...
          onClick={onToggle}
          className="flex w-full items-center justify-between gap-4 text-left cursor-pointer border-none bg-transparent p-0 focus:outline-none select-none"
        >
