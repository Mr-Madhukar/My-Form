...
export function RatingPanel({ field }: { readonly field: EditorField }) {
  ...
  return (
    <div className="flex animate-fade-up flex-col gap-5">
      ...
      <div className="flex flex-col gap-3 border-t border-white/[0.07] pt-4">
        ...
        <div className="flex gap-1.5 rounded-full bg-white/2 p-1 ring-1 ring-white/6">
          {([5, 10] as const).map((n) => (
            <Button
              key={n}
              type="button"
              ...
              className={cn(
                ...
                scale === n
                  ...
                  : "text-[#6B6B6B] hover:bg-white/5 hover:text-[#F2F2F2]",
              )}
            >
              {n}
            </Button>
